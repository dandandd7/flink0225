 ...
 */
public class Flink08_Window_eventTime_Tumbling_watermark_bounded_late_output {
    public static void main(String[] args) throws Exception {
        ...
        //先开启滚动窗口
        SingleOutputStreamOperator<String> process = keyedStream.window(TumblingEventTimeWindows.of(Time.seconds(5)))
        ...
        process.print("主流：");
        process.getSideOutput(new OutputTag<WaterSensor>("side"){}).print("侧输出流：");
        //测输出流是匿名内部类 需要在最后加{}
        env.execute();
    }
}
