...
public class Flink14_CEP_OrderToPay_TimeOut {
    public static void main(String[] args) throws Exception {
        ...
        Pattern<OrderEvent, OrderEvent> within = Pattern
        ...
        PatternStream<OrderEvent> pattern = CEP.pattern(keyedStream, within);
        SingleOutputStreamOperator<String> select = pattern.select(new OutputTag<String>("overtime") {
        ...
        select.print("主流:");
        select.getSideOutput(new OutputTag<String>("overtime"){}).print("overtime:");
        env.execute();
    }
