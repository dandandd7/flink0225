 ...
 */
public class TestBatch2_lambda {
    public static void main(String[] args) throws Exception {
        ...
        //开始处理
        //flatmap    使用lambda表达式
        final FlatMapOperator<String, Tuple2<String, Long>> stringTuple2FlatMapOperator = dataSource.flatMap(new FlatMapFunction<String, Tuple2<String, Long>>() {
